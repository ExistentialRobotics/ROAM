...
from utilities.util import rc_to_xy, get_rotation_matrix_2d, which_coords_in_bounds, compute_circumscribed_radius, clip_range, xy_to_rc
...
class CustomFootprint:
    ...
    def draw_circumscribed(self, state, visualization_map, radius=None):
        """
